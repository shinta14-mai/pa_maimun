...
class RekomteknisControllers extends Controller
{
    /**
    ...
    {
        return Inertia::render('RekomTeknis/Create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (Rekomtek::where('kode', $code)->exists()) {
        ...
        return Inertia::render('RekomTeknis/Store', [
            'code' => $codeR,
        ]);
    }
