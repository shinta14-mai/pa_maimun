    ...
    >
      ...
      >
        <div
          ...
          "
        >
          <span class="inline-flex justify-center items-center p-8">
            <img
          ...
          <ul class="flex flex-col py-4 mb-24 space-y-1">
            ...
            <li>
              ...
              >
                ...
                <span class="ml-2 text-sm tracking-wide truncate">Info</span>
                <span
                  class="
                    hidden
                    md:block
...
import AndalCreate from "@/Pages/Andalalin/Create.vue";
