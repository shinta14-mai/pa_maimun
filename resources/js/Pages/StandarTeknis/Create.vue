              ...
              <div class="px-10">
                <div>
                  ...
                  <jet-input
                    ...
                    type="file"
                    class="mt-1 block w-full"
                    @input="st.surat_pemohon = $event.target.files[0]"
                    required
                    autofocus
                  />
                </div>
                ...
                <div class="mt-4">
                  ...
                  <jet-input
                    ...
                    type="file"
                    class="mt-1 block w-full"
                    @input="st.ktp = $event.target.files[0]"
                    required
                    autofocus
                  />
                </div>
                ...
                <div class="mt-4">
                  ...
                  <jet-input
                    ...
                    type="file"
                    class="mt-1 block w-full"
                    @input="st.sertifikat_tanah = $event.target.files[0]"
                    required
                    autofocus
                  />
                </div>
                ...
                <div class="mt-4">
                  ...
                  <jet-input
                    ...
                    type="file"
                    class="mt-1 block w-full"
                    @input="st.ktr = $event.target.files[0]"
                    required
                    autofocus
                  />
                </div>
                ...
                <div class="mt-4">
                  ...
                  <jet-input
                    ...
                    type="file"
                    class="mt-1 block w-full"
                    @input="st.rencana_tapak = $event.target.files[0]"
                    required
                    autofocus
                  />
                </div>
                ...
                <div class="mt-4">
                  ...
                  <jet-input
                    ...
                    type="file"
                    class="mt-1 block w-full"
                    @input="st.desain_bangunan = $event.target.files[0]"
                    required
                    autofocus
                  />
                </div>
